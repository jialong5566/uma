...
import {generateFile, installDeps, logger, prompts, updatePackageJSON} from "@umajs/utils";
...
`,
    ...
    async fn({ args}){
      ...
      if(type){
        ...
        const getEnableGenerators = async (generators: typeof api.service.generators) => {
